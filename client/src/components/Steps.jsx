    ...
    return (
        <div className='mx-4 lg:mx-44 py-20 xl:py-40'>
            ...
            <div className='flex items-start flex-wrap gap-4 my-16 xl:mt-24 justify-center bg-red-200'>
                <div className='flex items-start gap-4 bg-white  drop-shadow-md p-7 pb-10 rounded-lg hover:scale-105 transition-all duration-300 min-w-[350px]'>
                    <img className='max-w-9' src={assets.upload_icon} alt="" />
                    <div>
                        <p className='text-xl font-medium'>Effortless Upload</p>
                        <p className='text-sm text-neutral-500 mt-1'>Quickly upload your images to get started <br /> in just a click!</p>
                    </div>
                </div>
                ...
                <div className='flex items-start gap-4 bg-white  drop-shadow-md p-7 pb-10 rounded-lg hover:scale-105 transition-all duration-300 min-w-[350px]'>
                    ...
                    <div>
                        <p className='text-xl font-medium'>One-Click Background Removal</p>
